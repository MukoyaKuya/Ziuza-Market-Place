...
SEED = [
    ...
    ('Custom & Branding', 'branding-custom', 'Custom t-shirts, lapels, corporate merchandise & branding services', 'shirt', [
        ('Custom T-Shirts & Polos', 'custom-tshirts'),
        ('Lapel Pins, Badges & Medals', 'lapel-pins-badges'),
        ('Corporate Merchandise & Gift Sets', 'corporate-merchandise'),
        ('Embroidery, Screen Printing & Vinyl', 'embroidery-screen-printing'),
        ('Banners, Signage & Roll-Ups', 'banners-signage'),
        ('Branded Drinkware, Mugs & Bottles', 'branded-drinkware'),
        ('Branded Stationery & Packaging', 'branded-stationery-packaging'),
        ('Custom Caps, Hoodies & Uniforms', 'custom-caps-uniforms'),
    ]),
    ('Craft Supplies & Tools', 'craft-supplies', 'Tools, materials, beads & essentials', 'scissors', []),
    ('Fabrications & Metalwork', 'fabrications-metalwork', 'Custom metalwork, gates, laser cutting, welding & structural fabrications', 'metalwork', [
        ('Custom Metalwork & Welding', 'metalwork-welding'),
        ('Gates, Grilles & Railings', 'gates-grilles-railings'),
        ('Laser Cutting & CNC Routing', 'laser-cutting-cnc'),
        ('Custom Metal & Wood Furniture', 'metal-wood-furniture'),
        ('Sheet Metal & Aluminum Fabrication', 'sheet-metal-aluminum'),
        ('Signage Frames & Lightboxes', 'signage-frames-lightboxes'),
        ('Custom Brackets, Mounts & Hardware', 'brackets-mounts-hardware'),
        ('Acrylic & Composite Fabrication', 'acrylic-composite-fabrication'),
    ]),
